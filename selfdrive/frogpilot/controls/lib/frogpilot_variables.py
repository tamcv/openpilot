...
class FrogPilotVariables:
  ...
  def update_frogpilot_params(self, started=True):
    ...
    toggles.always_on_lateral_pause_speed = self.params.get_int("PauseAOLOnBrake") if toggles.always_on_lateral else 0
    ...
    toggles.lane_detection_width = self.params.get_int("LaneDetectionWidth") * distance_conversion / 10 if toggles.nudgeless else 0
